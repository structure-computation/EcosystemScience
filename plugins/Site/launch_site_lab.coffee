    ...
    if $.cookie("email") and $.cookie("password")
        ...
        xhr_object.onreadystatechange = ->
            if @readyState == 4 and @status == 200
                ...
                if user_id > 0
                    launch_site_lab user_id, decodeURIComponent lst[ 1 ].trim()
                else
...
#main program
launch_site_lab = ( userid, home_dir, main = document.body ) ->
            ...
            fs.load path, ( td, err ) ->
                if err
                    ...
                    if not soft_hub_data
                        ...
                        session.add_child soft_hub_data
